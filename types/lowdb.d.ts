declare var _lowdb:_lowdb.LowFactory

declare module _lowdb
{
    ...
    interface LoDashWrapper
    {
         ...
         * @see _.assign
         */
        assign<TSource extends {}, TResult extends {}>(source: TSource): LoDashWrapper;

        /**
         * @see _.assign
         */
        assign<TSource1 extends {}, TSource2 extends {}, TResult extends {}>(source1: TSource1,
                                                                             source2: TSource2): LoDashWrapper;
        ...
        assign<TSource1 extends {}, TSource2 extends {}, TSource3 extends {}, TResult extends {}>(source1: TSource1,
                                                                                                  source2: TSource2,
                                                                                                  source3: TSource3): LoDashWrapper;
        ...
        assign<TSource1 extends {}, TSource2 extends {}, TSource3 extends {}, TSource4 extends {}, TResult extends {}>(source1: TSource1,
                                                                                                                       source2: TSource2,
                                                                                                                       source3: TSource3,
                                                                                                                       source4: TSource4): LoDashWrapper;
        ...
        get<TResult>(object: Object,
                     ...
                     defaultValue?: TResult): LoDashWrapper;
        ...
        mixin<TResult>(source: Dictionary<Function>,
                       options?: MixinOptions): LoDashWrapper;

        /**
         * @see _.mixin
         */
        mixin<TResult>(options?: MixinOptions): LoDashWrapper;
        ...
        set<V, TResult>(path: StringRepresentable | StringRepresentable[],
                        value: V): LoDashWrapper;

        /**
         * @see _.find
         */
        find<T>(predicate?: ListIterator<T, boolean>,
                thisArg?: any): LoDashWrapper;
         ...
         * @see _.find
         */
        find<TObject extends {}>(predicate?: TObject): LoDashWrapper;

        /**
         * @see _.find
         */
        filter<TObject extends {}>(predicate?: TObject): LoDashWrapper;

        /**
         * @see _.filter
         */
        filter<T>(predicate?: ListIterator<T, boolean>,
                  thisArg?: any): LoDashWrapper;
         ...
         * @see _.map
         */
        map<T, TResult>(iteratee?: ListIterator<T, TResult>,
                        thisArg?: any): LoDashWrapper;

        /**
         * @see _.map
         */
        map<TResult>(iteratee?: string): LoDashWrapper;

        /**
         * @see _.map
         */
        map<TObject extends {}>(iteratee?: TObject): LoDashWrapper;
        /**
         * @see _.map
         */
         ...
         * @see _.remove
         */
        remove<T>(predicate?: ListIterator<T, boolean>,
                  thisArg?: any): LoDashWrapper;
         ...
         * @see _.remove
         */
        remove<W>(predicate?: W): LoDashWrapper;

        /**
         * @see _.sortBy
         */
        sortBy<T, TSort>(iteratee?: ListIterator<T, TSort>): LoDashWrapper;
         ...
         * @see _.times
         */
        times<TResult>(iteratee: (num: number) => TResult): LoDashWrapper;
