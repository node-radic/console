...
var Log = (function () {
    ...
    Log.prototype.getTransports = function () {
        return Object.keys(this.winston.transports);
    };
    Log.prototype.getTransport = function (transport) {
    ...
    Log.prototype.setLevel = function (transport, level) {
        ...
        if (level) {
            ...
            this.getTransports().forEach(function (transport) { return _this.setLevel(transport, level); });
        }
        return this;
    };
    Log.prototype.getWinston = function () {
        return this.winston;
    };
    ...
    Log.prototype._log = function (name) {
        var args = [];
    ...
    Log.prototype.on = function (event, handler) {
