...
import {IDefinition, IArgumentDefinition, IDefinitionSignatureParser} from "../interfaces";
 ...
 */
export class DefinitionSignatureParser implements IDefinitionSignatureParser
{
    @inject(BINDINGS.OPTIONS_DEFINITION)
    public definition: IDefinition;

    public signature: string;

    parse(signature: string): IDefinition {
    ...
    protected parseArgument(token: string|any) {
        ...
        let arg = <IArgumentDefinition> {name: token, description: desc, required: false, type: 'string', default: null}
