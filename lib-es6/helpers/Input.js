...
var InputHelper = (function () {
    ...
    InputHelper.prototype.ask = function (message, def) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.prompt({ default: def, type: 'input', message: message })];
            });
        });
    };
    InputHelper.prototype.checkbox = function (msg, choices, validate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.multiple(msg, 'checkbox', choices, validate)];
            });
        });
    };
    InputHelper.prototype.list = function (msg, choices, validate) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.multiple(msg, 'list', choices, validate)];
            });
        });
    };
    ...
    InputHelper.prototype.confirm = function (message, def) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.prompt({ type: 'confirm', default: def, message: message })];
            });
        });
    };
    InputHelper.prototype.password = function (message, def) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.prompt({ type: 'password', default: def, message: message })];
            });
        });
    };
    InputHelper.prototype.prompts = function (questions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, inquirer.prompt(questions)];
            });
        });
    };
    InputHelper.prototype.prompt = function (question) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2, inquirer.prompt([question])
